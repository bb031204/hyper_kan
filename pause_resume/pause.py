...
使用方法：
    ...
    # 100分钟后暂停
    python pause.py --pause-time 100
...
def find_latest_run(outputs_dir: str = "outputs"):
    ...
    full_outputs_dir = os.path.join(script_dir, outputs_dir)
...
def main():
    parser = argparse.ArgumentParser(
        description='HyperGKAN - 训练暂停工具',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python pause.py                  # 立即暂停最新训练
  python pause.py --pause-time 100 # 100分钟后暂停
        """
    )
